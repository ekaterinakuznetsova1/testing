...
(function() {
    ...
    const CONFIG = {
        ...
        UI_WIDTH_PERCENT_VIEWPORT: 85,
        UI_HEIGHT_PERCENT_VIEWPORT: 25, // Adjusted for new layout, can be less if notes are small
        UI_MIN_HEIGHT_PX: 200,          // Min height to prevent collapse
        ...
        MAIN_ACCENT_COLOR: 'rgba(80, 80, 80, 0.5)',      // More neutral accent
        ...
        DEFAULT_NIGHT_SHIFT_START_TIME: '18:29',
    ...
    function buildMainUI() {
        ...
        const controlButtonBaseStyle = {
            ...
            color: CONFIG.UI_TEXT_COLOR, borderRadius: '3px', padding: '2px 6px', fontSize: '0.8em',
        ...
        state.domElements.decrementButton = createDOMElement('button', {
            ...
            style: { ...clickerBtnStyle, backgroundColor: CONFIG.DECREMENT_BUTTON_COLOR, marginRight: '10px' }
        });
    ...
    function buildSettingsPanel() {
        const panel = createDOMElement('div', {
            ...
            style: {
                ...
                backgroundColor: `rgba(30, 35, 45, 0.95)`, // More opaque for settings
                // borderLeft: `2px solid ${CONFIG.MAIN_ACCENT_COLOR}`, // Accent border
                padding: '20px', zIndex: '1000', display: 'none', flexDirection: 'column',
                gap: '18px', overflowY: 'auto', boxShadow: '-10px 0px 25px rgba(0,0,0,0.3)',
    ...
    function initializeMutationObserver() {
        ...
        const observerCallback = (mutationsList) => {
            ...
            if (state.isTriggerWordCurrentlyVisible && !state.clickedForThisTriggerInstance) {
                logInfo_v2(`Auto-incrementing for "${CONFIG.AUTO_CLICK_TRIGGER_WORD}"`);
