        ...
        build: () => {
            state.dom.settingsPanel = Utils.createDOMElementBase('div', { // Base to control its own pointer events precisely
                ...
                style: {
                    ...
                    backgroundColor: `rgba(40, 45, 55, 0.98)`, borderLeft: `2px solid ${CONFIG.MAIN_ACCENT_COLOR}`,
                    padding: '15px 20px', zIndex: '10', display: 'flex', flexDirection: 'column', gap: '10px', overflowY: 'auto',
                    boxShadow: '-8px 0px 20px rgba(0,0,0,0.3)', transform: 'translateX(101%)',
            ...
            const saveThemeBtn = Utils.createDOMElementBase('button', {textContent: 'Save Custom Appearance for This URL', style: {...commonInputStyle, backgroundColor: `${CONFIG.MAIN_ACCENT_COLOR}bb`, color:'white', marginTop:'8px', cursor:'pointer'}, className:'ph-interactive'});
            ...
            const closeButton = Utils.createDOMElementBase('button', { textContent: 'Apply & Close', className: 'ph-settings-close-btn ph-interactive', style: { cursor: 'pointer', backgroundColor: `${CONFIG.MAIN_ACCENT_COLOR}dd`, border: 'none', color: 'white', borderRadius: '5px', padding: '10px 15px', fontSize: '1em', width: '100%', marginTop: 'auto', transition: 'background-color 0.2s' }});
