...
(function() {
    ...
    function buildSettingsPanel() {
        // (Как в прошлой версии, но с обновленными ID, текстами и логикой для обеда)
        const panel = createDOMElement('div', {
            id: CONFIG.SETTINGS_PANEL_ID,
            style: {
                position: 'absolute', top: '-2px', right: '-2px', bottom: '-2px', // нахлест на рамку
                width: '300px', // Немного шире
                backgroundColor: CONFIG.UI_BACKGROUND_COLOR, // Такой же фон как у основного UI
        ...
        // (опции добавятся в setInitialUIStates или при загрузке)
        ...
        const closeButton = createDOMElement('button', {textContent: 'Применить и Закрыть', style: {...commonButtonStyle, width: '100%', marginTop: 'auto', padding: '10px', fontSize: '1em', backgroundColor: `${CONFIG.MAIN_ACCENT_COLOR}cc`}});
